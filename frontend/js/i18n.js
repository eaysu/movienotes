...
const EN = Object.freeze({
  ...
  'Bu hafta vizyonda': 'In theatres this week', 'Listeyi aç': 'Open list',
  ...
  'En sevdiğin 10 filmi seç': 'Choose your 10 favourite films', '0 / 10 seçili': '0 / 10 selected',
  ...
  'En sevdiğin 10 film': 'Your 10 favourite films', 'Günce': 'Diary',
  ...
  'Letterboxd geçmişin': 'Your Letterboxd history', 'Favori dörtlün': 'Your Fav 4', 'Favori yönetmenin': 'Your favourite director',
  ...
  'Hazır': 'Ready', 'Zevk profilin hazır': 'Your taste profile is ready',
  'Tüm izleme geçmişin ve yönetmen verilerin analiz edildi. İçeri girip bu geceye bir film seçelim.': 'Your full viewing history and director data have been analysed. Let’s go in and pick a film for tonight.',
  'Tam analiz doğrulanıyor; tamamlanmadan profile geçilmeyecek.': 'The full analysis is being verified; the profile will not open until it is complete.',
  'Hazır olduğunda uygulamaya geçebilirsin.': 'You can open the app when you are ready.', 'İleri / geri gezinebilirsin.': 'You can move forward or back.',
  'Tüm geçmişin ve yönetmen verilerin hazırlanıyor…': 'Your full history and director data are being prepared…',
  'Zevk profilin hazırlanıyor': 'Your taste profile is being prepared', 'Bağlantı yeniden kuruluyor': 'Reconnecting',
