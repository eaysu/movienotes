...
const EN = Object.freeze({
  ...
  'En çok beğenilen filmler arasından seç.': 'Choose from the most highly rated films.',
  'En çok hayranı olan filmler arasından seç.': 'Choose from films with the most fans.',
  'Top 500’den seç': 'Pick from Top 500', 'Top Fans 250’den seç': 'Pick from Top Fans 250',
  'Letterboxd listesi hazırlanıyor': 'Preparing the Letterboxd list',
  'Topluluk havuzu karıştırılıyor': 'Shuffling the community pool',
